              ...
              <div>
                ...
                <div className="flex gap-2 mt-2">
                  <button
                    ...
                    className="glass px-3 py-2 rounded-md text-white hover:bg-primary/20 transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="glass px-3 py-2 rounded-md text-white hover:bg-red-500/20 transition-colors"
                  >
                    Clear
                  </button>
                </div>
